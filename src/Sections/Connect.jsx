...
import con1 from '../assets/img/connect/connect1.jpeg'
import con2 from '../assets/img/connect/connect2.jpeg'
import con3 from '../assets/img/connect/connect3.jpeg'
...
const connec_info = [
 
  {
    id: 2,
    img: con1,
    name_connet: 'Formatic'
  },
  {
    id: 3,
    img: con2,
    name_connet: 'Trust Wallet'
  },
  {
    id: 4,
    img: con3,
    name_connet: 'WalletConnect'
  }
]
const Connect = ({connect_control}) => {
  return (
    <section>
      <main className=''>
        <div className="w-full bgblur bg-cover h-[100vh] flex items-center justify-center mx-auto  fixed bg-[#04040cd7] top-0 left-0 right-0 z-50">
          <div className='w-[95%] sm:w-[80%] md:w-[50%] lg:w-[35%] xl:w-[25%] flex flex-col  bg-gray-950 shadow-gray-600 shadow-2xl pb-5 '>
            ...
            <div className='flex_c flex-col gap-4  px-4 py-4'>
              ...
              <div className=' text-[10px] font-medium text-center text-gray-400'>
                <div>
                  <p>By connecting your wallet.you agree to our <span className=' font-bold text-[10px]'>Terms of </span></p>
                  <p><span className=' font-bold text-[11px]'>Services</span> and our <span className=' font-bold text-[11px]'>Privicy Policy</span></p>
